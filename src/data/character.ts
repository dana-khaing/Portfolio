...
export const character = {
  ...
  quests: [
    ...
    },
    {
      ...
      type: 'Solo Quest',
      description: 'Interactive developer portfolio styled as an RPG character status screen. Live GitHub API data, Framer Motion animations, particle effects, and fully responsive design.',
